...
---
This study examines the role of situational interest in classroom learning by combining laboratory and naturalistic paradigms. It models how interest fluctuates across learning episodes using physiological signals and links these dynamics to learning outcomes, providing a foundation for interest-based adaptive instruction.
*Preprint, bioRxiv*

![Figure](/images/papers/situational_interest_bioRxiv2022-01.png){: .align-center width='90%'}

![Figure](/images/papers/situational_interest_bioRxiv2022-02.png){: .align-center width='90%'}
